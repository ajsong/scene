/*
Developed by @mario v2.1.20201116
*/
window.$ = jQuery;
window.sceneNonSaveTip = true;
window.sceneSaved = true;
window.inputChanged = false;
...
function returnHome(){
	/*if(!window.sceneSaved && !window.inputChanged && window.sceneNonSaveTip){
		if(!confirm('您编辑的信息尚未保存，您确定要离开吗？'))return;
	}*/
...
function dialogResize(){
	...
	let parent = $('.dialog', top.document.body).css({width:document.body.scrollWidth, height:document.body.scrollHeight}).parent().css({width:document.body.scrollWidth});
	console.log(parent)
}
function grid(){
...
function publish(){
	...
	sceneSave(null, true, function(){
		...
		$.postJSON('/api/scene/publish', {id:id}, function(){
			location.href = '/index/scene/detail?id='+id;
		});
	});
}
function detail(){
	location.href = '/index/scene/detail?id=' + $('#id').val();
}
function setTips(el){
	setTimeout(function(){
		el.tips({
...
function sceneInit(){
	let content = $.base64Decode($('textarea.data').val().substr(5));
		...
		do{
			if($(o).is('.item') || $(o).is('.viewer')){
				...
				if(o.is('.viewer')){
					...
					html = '<div '+(!window.sceneElementClone?'class="disable"':'')+'>'+(!window.sceneElementClone?'':'<span class="eqf-right"></span>')+'粘贴'+(!window.sceneElementClone?'':'<ul><li><a href="javascript:void(0)" type="paste"><span>'+platformKey('Ctrl')+' + V</span>到画布</a></li><li><a href="javascript:void(0)" type="paste-mouse"><span>'+platformKey('Ctrl')+' + '+platformKey('Shift')+' + V</span>到鼠标位置</a></li></ul>')+'</div>';
				}else{
					contextmenu.removeAttr('target');
					if(!o.is('.control') || o.find('.resize-panel').css('display')==='none')o.click();
					window.contextmenuControl = o;
					html = '<a href="javascript:void(0)" type="cut"><span>'+platformKey('Ctrl')+' + X</span>剪切</a>\
					<a href="javascript:void(0)" type="copy"><span>'+platformKey('Ctrl')+' + C</span>复制</a>\
					<div '+(!window.sceneElementClone?'class="disable"':'')+'>'+(!window.sceneElementClone?'':'<span class="eqf-right"></span>')+'粘贴'+(!window.sceneElementClone?'':'<ul><li><a href="javascript:void(0)" type="paste"><span>'+platformKey('Ctrl')+' + V</span>到画布</a></li><li><a href="javascript:void(0)" type="paste-mouse"><span>'+platformKey('Ctrl')+' + '+platformKey('Shift')+' + V</span>到鼠标位置</a></li></ul>')+'</div>\
					<em></em>\
...
function menuInit(){
	...
	<div class="menu bg">\
		...
		<ul>\
			<li><a href="/index/scene/pic?type=bg" class="bg tips iframe-layer" width="770" tips-follow="right" title="'+platformKey('Shift')+' + B"><span class="eqf-top-pic"></span>图片</a></li>\
			<li><a href="javascript:void(0)" class="color"><span class="eqf-moban"></span>纯色</a></li>\
		</ul>\
	</div>\
	<a href="/index/scene/pic" class="menu pic tips iframe-layer" width="770" title="'+platformKey('Shift')+' + P"><em class="eqf-top-pic"></em>图片</a>\
	<a href="javascript:void(0)" class="menu text tips" coo-click="setText" title="'+platformKey('Shift')+' + T"><em class="eqf-text-word"></em>文字</a>\
	<a href="/index/scene/music" class="menu music tips iframe-layer" width="770" title="'+platformKey('Shift')+' + M"><em class="eqf-top-music"></em>音乐</a>\
	<a href="/index/scene/video" class="menu video tips iframe-layer" width="600" title="'+platformKey('Shift')+' + V"><em class="eqf-top-video"></em>视频</a>\
	<a href="javascript:void(0)" class="menu web tips" coo-click="setWeb" title="'+platformKey('Shift')+' + W"><em></em>网页</a>\
	<a href="/index/scene/map" class="menu map tips iframe-layer" width="770" title="'+platformKey('Shift')+' + D<br />建议整个场景只添加一个地图"><em></em>地图</a>\
	<a href="/index/scene/template" class="menu template tips iframe-layer" width="770" title="'+platformKey('Shift')+' + E"><em></em>模板</a>\
	<a href="javascript:void(0)" class="menu grid tips" coo-click="grid" title="'+platformKey('Shift')+' + G"><em class="eqf-wangge"></em>网格</a>\
	...
	<div class="menu pad tips" tips-skip="skipPad" title="隐藏边框 '+platformKey('Shift')+' + F">\
		...
		<ul>\
			<li><a href="javascript:void(0)" class="pad-face" coo-click="pad" data-face="iphone5s">iPhone 5s</a></li>\
			<li><a href="javascript:void(0)" class="pad-face" coo-click="pad" data-face="iphonex">iPhone X</a></li>\
			<li><a href="javascript:void(0)" class="pad-face" coo-click="pad" data-face="galaxys8">Galaxy S8</a></li>\
		</ul>\
	</div>\
	...
	$(document).on('mousedown', function(e){
		let o = e.target;
		do{
			if($(o).is('.bg') || $(o).is('.pad') || $(o).is('.colorpickerControl'))return true;
			o = o.parentNode;
		}while(o.parentNode);
	...
	$('.scene-menu div.menu').click(function(e){
		...
		do{
			if($(o).is('.color') || $(o).is('.colorpickerControl'))return true;
			o = o.parentNode;
		}while(o.parentNode);
	...
	$('.scene-menu .bg li:last a').colorpicker({
		target: null,
		readonly: false,
	...
	<ul class="view">\
		<li>\
			<div class="line share-info">\
				<a href="/index/scene/pic?type=cover" class="tips iframe-layer" title="更换封面" width="770"></a>\
				<div>\
					<em>标题</em>\
			...
			<div class="line music-info">\
				<a href="/index/scene/music" class="iframe-layer input width180" width="770">\
				...
				<a href="/index/scene/pic?type=music" class="iframe-layer tips music-button" width="770" max-width="50" data-src="'+((data.music_pic&&data.music_pic.length)?data.music_pic:'')+'">音乐图片</a>\
...
function toolbarInit(){
	$('.phone').after('<div class="toolbar hidden">\
		<div class="group picHidden videoHidden webHidden mapHidden">\
		...
		<div class="group videoHidden webHidden mapHidden">\
		...
		<div class="group videoHidden webHidden mapHidden">\
			...
			<ul style="width:100px;">\
				<li><a href="/index/scene/link" class="iframe-layer" width="600"><em class="eqf-link"></em> 添加超链接</a></li>\
	...
	$('.toolbar .group > a').each(function(){
		...
		if(_this.is('.style')){
			...
			let left = control.css('left').replace('px', ''), top = control.css('top').replace('px', ''), width = '', height = '';
			...
			if(!!control.attr('fulladaption')){
				...
				control.attr({left:left, top:top, width:width, height:height});
				ul.find('.fulladaption input').removeAttr('checked').prop('checked', false);
				control.css({left:Number(control.attr('left')||0), top:Number(control.attr('top')||0), width:Number(control.attr('width')||0), height:Number(control.attr('height')||0)});
	...
	$('.toolbar .group ul.style .fulladaption input').on('change', function(){
		...
		if(this.checked){
			control.attr('fulladaption', 'fulladaption').css({left:0, top:0, width:'100%', height:'100%'});
			ul.find('.x input, .y input, .width input, .height input').attr('disabled', 'disabled').prop('disabled', true);
...
function linkareaInit(){
	$('.phone').after('<div class="linkarea">\
		<div><span><em></em><i></i></span><a href="/index/scene/link" class="iframe-layer" width="600"></a></div>\
...
function pageInit(){
	$.getJSON('/api/scene/getPages', {id:$('#id').val()}, function(json){
		if(json.data.length===1)$('.pages a.del').addClass('hidden');
		$.each(json.data, function(){
			pageAdd(null, this.title, this.bg, this.content, true);
		});
...
function contextmenuOperate(elementType){
	...
	if(elementType!=='copy')window.sceneSaved = false;
...
function selectAreaEnd(e){
	...
	$('.viewer .item:not(.lock)').each(function(){
		...
		if(collision(selectarea, div) || collision(div, selectarea)){
			setTimeout(function(){div.click()}, 0);
			return false;
		}
	});
...
function pageAdd(e, title, bg, content, nonMenu){
	window.sceneSaved = false;
	let ul = $('.pages ul'), length = ul.find('li').removeClass('this').length;
	...
	let li = '<li class="this">\
		<div>\
			<label class="checkbox tips" title="在场景中显示" tips-follow="left"><input type="checkbox" name="status" value="1" checked /><div><span></span></div></label>\
...
function pageCopy(e){
	...
	pageAdd(e, '副本-'+page.find('.title').val(), page.find('.bg').val(), page.find('.content').val());
}
function pageDel(){
...
function pageTemplate(){
	...
	$.postJSON('/api/scene/addTemplate', { bg:bg, content:content }, function(){
		showToast('模板保存成功');
	});
}
...
function setPic(obj, nonMenu, nonLoadImage){
	...
	window.sceneSaved = false;
	$('.boxer > .loading').removeClass('hidden');
	let viewer = $('.viewer:last'), width = viewer.width(), url = obj.url, style = (typeof obj.style=='undefined' ? '' : obj.style), link = '', fulladaption = '',
		lock = (typeof obj.lock=='undefined' ? 0 : Number(obj.lock)), image = new Image();
	image.src = url;
	let s = function(){
		$('.boxer > .loading').addClass('hidden');
		...
		if(typeof obj.fulladaption!=='undefined' && obj.fulladaption===1)fulladaption = 'fulladaption="fulladaption"';
		let div = $('<div class="item '+(lock===1?'lock':'')+'" type="image" title="按住鼠标进行拖动，双击鼠标更换图片" url="'+url+'" style="'+style+'" '+link+' '+fulladaption+'>'+(link.length?'<em></em>':'')+'<img src="'+url+'" /></div>');
		viewer.append(div);
		...
		div.dblclick(function(){
			...
			if($(this).hasClass('lock'))return;
			iframeLayer('/index/scene/pic', 770);
		});
		if(typeof nonMenu=='undefined'){
			setTimeout(function(){
				if($('body').hasClass('scene-preview'))return;
...
function setText(obj, nonMenu){
	if($(this).hasClass('disable'))return false;
	window.sceneSaved = false;
	let viewer = $('.viewer:last'), text = (typeof obj.text=='undefined' ? '' : obj.text), style = (typeof obj.style=='undefined' ? '' : obj.style), link = '',
	...
	if(typeof obj.link_type!='undefined' && /^(web|page)$/.test(obj.link_type))link = ' link="'+obj.link_type+':'+obj.link_value+'"';
	let div = $('<div class="item '+(lock===1?'lock':'')+'" type="text" title="按住鼠标进行拖动，双击鼠标编辑文字" style="'+style+'" '+link+'>'+(link.length?'<em></em>':'')+'<span><font>'+text+'</font></span></div>');
	viewer.append(div);
	if(style.indexOf('opacity')>-1){
		let matcher = style.match(/opacity:\s*([\d.]+);/);
	...
	div.ZResize({
		...
		hide: function(){
			$('.toolbar').addClass('hidden');
			$('.linkarea').addClass('hidden');
			this.removeClass('control').find('font').removeAttr('contenteditable');
			this.find('.resize-panel').css('z-index', '');
		}
	}).tapper(function(){
		if(!$('body').hasClass('scene-preview') || !!!$(this).attr('link'))return true;
	...
	div.dblclick(function(){
		if($('body').hasClass('scene-preview'))return;
		if($(this).hasClass('lock'))return;
		$(this).find('font').attr('contenteditable', 'true').focus().select();
...
function setVideo(obj, nonMenu){
	if($(this).hasClass('disable'))return false;
	window.sceneSaved = false;
	let viewer = $('.viewer:last'), code = obj.code||'', style = (typeof obj.style=='undefined' ? '' : obj.style),
		lock = (typeof obj.lock=='undefined' ? 0 : Number(obj.lock));
	if(typeof obj.control!='undefined' && obj.control){
	...
	let div = $('<div class="item '+(lock===1?'lock':'')+'" type="video" title="按住鼠标进行拖动，双击鼠标更换视频" style="'+style+'"><textarea>'+code+'</textarea><i class="eqf-play2"></i></div>');
	viewer.append(div);
	div.ZResize({
		restrict: true,
		suck: 2,
	...
	div.dblclick(function(){
		if($('body').hasClass('scene-preview'))return;
		if($(this).hasClass('lock'))return;
		iframeLayer('/index/scene/video', 600);
	});
	if(typeof nonMenu=='undefined'){
		setTimeout(function(){div.click()}, 0);
	}
...
function setWeb(obj, nonMenu){
	if($(this).hasClass('disable'))return false;
	window.sceneSaved = false;
	let viewer = $('.viewer:last'), url = obj.url||'', style = (typeof obj.style=='undefined' ? '' : obj.style),
		lock = (typeof obj.lock=='undefined' ? 0 : Number(obj.lock));
	let placeholder = '双击编辑URL，仅支持http,https协议网站';
	if(!style.length)style = 'left:0;top:0;width:100%;height:170px;';
	let div = $('<div class="item '+(lock===1?'lock':'')+'" type="web" url="'+url+'" title="按住鼠标进行拖动，双击鼠标编辑网址" style="'+style+'"><h6><i></i><i></i><strong><p>'+(url.length?url:placeholder)+'</p></strong></h6><h4><p>Web Page</p></h4></div>');
	viewer.append(div);
	div.ZResize({
		restrict: true,
		suck: 2,
...
function setMap(obj, nonMenu){
	if($(this).hasClass('disable'))return false;
	window.sceneSaved = false;
	let viewer = $('.viewer:last'), style = (typeof obj.style=='undefined' ? '' : obj.style),
		lock = (typeof obj.lock=='undefined' ? 0 : Number(obj.lock)),
	...
	if(!style.length)style = 'left:0;top:0;width:100%;height:170px;';
	let div = $('<div class="item '+(lock===1?'lock':'')+'" type="map" title="按住鼠标进行拖动，双击鼠标进行编辑" style="'+style+'" longitude="'+longitude+'" latitude="'+latitude+'" zoom="'+zoom+'"><i></i></div>');
	viewer.append(div);
	...
	div.dblclick(function(){
		if($('body').hasClass('scene-preview'))return;
		if($(this).hasClass('lock'))return;
		iframeLayer('/index/scene/map', 770);
	});
	if(typeof nonMenu=='undefined'){
		setTimeout(function(){div.click()}, 0);
	}
...
function setSimplePic(viewer, obj){
	let width = viewer.width(), url = obj.url, style = (typeof obj.style=='undefined' ? '' : obj.style), image = new Image();
	image.src = url;
	let s = function(){
		let imageWidth = image.width, imageHeight = image.height;
		if(imageWidth > width){
...
function setSimpleText(viewer, obj){
	let text = (typeof obj.text=='undefined' ? '' : obj.text), style = (typeof obj.style=='undefined' ? '' : obj.style);
	if(!text.length)text = '双击此处进行编辑';
	if(!style.length)style = 'left:0;top:0;width:100%;height:38px;font-size:24px;line-height:1;';
...
function setSimpleWeb(viewer, obj){
	let url = obj.url||'', style = (typeof obj.style=='undefined' ? '' : obj.style);
	let placeholder = '双击编辑URL，仅支持http,https协议网站';
	if(!style.length)style = 'left:0;top:0;width:100%;height:170px;';
	let div = $('<div class="item" type="web" style="'+style+'"><h6><i></i><i></i><strong><p>'+(url.length?url:placeholder)+'</p></strong></h6><h4><p>Web Page</p></h4></div>');
	viewer.append(div);
}
...
function sceneSave(e, nonToast, callback){
	...
	$.postJSON('/api/scene/edit', params, function(json){
		window.sceneSaved = true;
		$('#id').val(json.data);
		if(!nonToast)showToast('场景保存成功');
...
function sceneGift(id, username){
	...
	$.postJSON('/api/scene/gift', {id:id, username:username}, function(){
		showToast('转赠成功');
		setTimeout(function(){
...
function sceneCopy(id){
	$.overload(null, '.load-animate load-animate2');
	$.postJSON('/api/scene/copy', {id:id}, function(json){
		let data = json.data,
		html = '<li scene="'+data.id+'" class="scale-out">\
			...
			<div class="lay">\
				<a href="/index/scene/publish?id='+data.id+'"><em class="eqf-scene-send"></em>发布</a>\
				<a href="/index/scene/'+data.id+'"><em class="eqf-xiuziti"></em>编辑</a>\
				<a href="/index/scene/detail?id='+data.id+'"><em class="eqf-date"></em>详情</a>\
			</div>\
			<div class="view">\
				<div class="project">\
					<div>'+data.title+'</div>\
				...
				<div class="button">\
					<a href="/index/scene/'+data.id+'#showSet"><em class="eqf-scene-setting"></em><span>设置</span></a>\
					<a href="/index/scene/publish?id='+data.id+'" class="publish"><em class="eqf-scene-send"></em><span>发布</span></a>\
					<a href="/index/scene/gift?id='+data.id+'" class="gift iframe-layer"><em class="eqf-scene-gift"></em><span>转赠</span></a>\
					<a href="/index/scene/copy?id='+data.id+'" class="copy iframe-layer"><em class="eqf-scene-copy"></em><span>复制</span></a>\
					<a href="/index/scene/delete?id='+data.id+'" class="del iframe-layer"><em class="eqf-scene-delete"></em><span>删除</span></a>\
...
function sceneDelete(id){
	$.overload(null, '.load-animate load-animate2');
	$.postJSON('/api/scene/delete', {id:id}, function(){
		setTimeout(function(){
			let li = $('.section ul li[scene="'+id+'"]').addClass('scale-out');
			setTimeout(function(){
				li.remove();
...
function setStatus(){
	...
	$.postJSON('/api/scene/status', {id:request.id, status:status});
}
